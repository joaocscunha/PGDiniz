				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title text-center"> Imagem 3 </h2>
							<div class="row">
								<div class="col-md-12 col-md-offset-1">
									...
									<form method="post" class="form-horizontal" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label">Imagem 3 Atual</label>
											<?php
											$id = intval($_GET['imgid']);
										...
										<div class="form-group">
											<label class="col-sm-4 control-label">Nova Imagem 3 <span style="color:red">*</span></label>
											<div class="col-sm-8">
