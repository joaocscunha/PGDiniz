				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title text-center">Gerir Contactos</h2>
							...
							<div class="row">
								<div class="col-md-10">
									<form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
										...
										<?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong><?php echo htmlentities($msg); ?></strong> </div><?php } ?>
										...
										if ($query->rowCount() > 0) {
											foreach ($results as $result) {				?>
												...
												<div class="form-group">
													<label class="col-sm-4 control-label"> Morada</label>
													<div class="col-sm-8">
