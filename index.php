...
<head>
  ...
  <title>Plataforma Rent-a-Car</title>
...
<body>
  ...
  <body style="margin: 0;padding: 0; height: 100%;">
    <!-- Banners -->
    <section id="banner" class="banner-section" style="padding:20%;background-image:url(assets/images/audi_index.jpg">
      <div class="container" style="margin-top:5%">
        <div class="div_zindex">
          <div class="row">
            <div class="col-md-5">
              <div class="banner_content">
                <h1>À procura de um veículo? Está no sítio certo.</h1>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section-padding" style="background-color:#111111;">
      <div class="container">
        <div class="section-header text-center">
          <h4 style="color:white"><strong>Recentemente Adicionados</strong></h4>
        </div>
        <div class="row">
              ...
              ?>
                  ...
                  <div class="col-list-3">
                    <div class="recent-car-list">
                      <div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><img class="car-image" src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" class="img-responsive" alt="image"></a>
                        <ul>
