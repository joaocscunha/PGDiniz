...
?>
  ...
  <head>
    ...
    <title>Car Rental Portal | Perfil</title>
    <!--Bootstrap -->
              ...
              <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-6 col-sm-8">
                  <div class="profile_wrap">
                    ...
                    <form method="post">
                    <h5 class="uppercase underline">Perfil</h5>
                      ...
                      <div class="form-group">
                        <label class="control-label">Nº Telemóvel</label>
                  ...
                  <div class="form-group">
                    <button type="submit" name="updateprofile" class="btn">Guardar Alterações <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                  </div>
                    </form>
                  </div>
                </div>
