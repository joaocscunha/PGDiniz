  ...
  if (isset($_POST['update'])) {
    ...
    if($newpassword == $confirmpassword){
      if ($query->rowCount() > 0) {
        ...
        $error = "Password Atual Errada";
      }
    }
    else{
      $error = "Nova Password e Confirmar Password não são iguais";
    }
            ...
            <div class="col-md-6 col-sm-8">
              <div class="profile_wrap">
                <form name="chngpwd" method="post" onSubmit="return valid();">
                  <h5 class="uppercase underline">Mudar Password</h5>
                  ...
                  <div class="form-group">
                    <input type="submit" value="Atualizar" name="update" id="submit" class="btn btn-block">
                  </div>
                </form>
              </div>
            </div>
